...
Visit the [Software Carpentry Lessons website](https://software-carpentry.org/lessons/) to see the most up to date listing of our lesson
...
* Put up posters and flyers in places where researchers might see them. For example in/near research student offices.
* Send emails to mailing lists of people who might be interested. For example research students, research staff and HPC users.
* Get it added to your university’s events calendar or sent onto events mailing lists.
* Mention them in Software Carpentry workshops or any other relevant presentations.
* Tell anyone you know who’s looking for help that it’s a good time to ask.
* Tell anyone you know who might offer help that it’s a good time to offer it. If providing this kind of support isn’t really their job it can be a good way of restricting it to just an hour a week.
...
* UQ Hacky Hour [blog](https://hackyhourstluc.wordpress.com/) and [Twitter feed](https://twitter.com/hackyhourstluc)
...
* [Murdoch University Hacky hour](https://twitter.com/HackyH_Murdoch)
...
* Aberystwyth University [website](https://tinyurl.com/HackyHourAber), [facebook](https://www.facebook.com/hackyhouraber/) and [twitter](https://twitter.com/hackyhouraber).
...
Study groups are an activity you can bring to your local campus in order to build a local community that focuses on learning new skills together. Study groups range from discipline specific to tool specific (a particular programming language) to open and wide ranging. Overall the idea of a study group is to collectively set some objectives and learning goals and work together to accomplish them as a team. This takes a motivated group and it can help to have a few intermediate to advanced practitioners involved to help it get going faster.
...
THATCamp is an open unconference model for bringing a skills meetup to your university or organization. Being an unconference it is highly flexible and up to you and your organizing committee to make it work. It is a popular model in academic libraries and digital humanities centres around the world.
